...
module Conv_sysarr_dataflow_in_loop_LOOP_S_OUTER_entry25 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input   p_out8_full_n;
output   p_out8_write;
output  [8:0] ho_out_din;
input   ho_out_full_n;
output   ho_out_write;
output  [8:0] ho_out9_din;
input   ho_out9_full_n;
output   ho_out9_write;
output  [8:0] wo_out_din;
input   wo_out_full_n;
output   wo_out_write;
output  [8:0] wo_out10_din;
input   wo_out10_full_n;
output   wo_out10_write;
output  [8:0] p_out11_din;
...
assign ro_out3_din = ro[8:0];

assign ro_out_din = ro;

assign so_out4_din = so[8:0];
...
endmodule //Conv_sysarr_dataflow_in_loop_LOOP_S_OUTER_entry25
