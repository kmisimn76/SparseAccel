...
/home/sumin/tools/Xilinx/Vivado/Vivado/2020.1/bin/xsim --noieeewarnings Conv_sysarr -tclbatch Conv_sysarr.tcl -gui -view Conv_sysarr_dataflow_ana.wcfg -protoinst Conv_sysarr.protoinst
