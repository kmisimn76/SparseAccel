...
/home/sumin/tools/Xilinx/Vivado/Vivado/2020.1/bin/xsim --noieeewarnings Conv_sysarr_dbbuf -tclbatch Conv_sysarr_dbbuf.tcl -gui -view Conv_sysarr_dbbuf_dataflow_ana.wcfg -protoinst Conv_sysarr_dbbuf.protoinst
