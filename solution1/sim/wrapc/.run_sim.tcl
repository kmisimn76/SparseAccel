...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Conv_sysarr.autotvin.dat"
	set constFileTvOut       "Conv_sysarr.autotvout.dat"
	set constFileHdlTvIn     "Conv_sysarr.autohdltvin.dat"
	set constFileHdlTvOut    "Conv_sysarr.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
