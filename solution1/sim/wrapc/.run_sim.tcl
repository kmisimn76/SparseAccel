...
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx_vitis/Vitis/Vitis/2020.1/lnx64/tools/fpo_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx_vitis/Vitis/Vitis/2020.1/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx_vitis/Vitis/Vitis/2020.1/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx_vitis/Vitis/Vitis/2020.1/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/sumin/tools/Xilinx_vitis/Vitis/Vitis/2020.1/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "Conv_sysarr_dbbuf.autotvin.dat"
	set constFileTvOut       "Conv_sysarr_dbbuf.autotvout.dat"
	set constFileHdlTvIn     "Conv_sysarr_dbbuf.autohdltvin.dat"
	set constFileHdlTvOut    "Conv_sysarr_dbbuf.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
