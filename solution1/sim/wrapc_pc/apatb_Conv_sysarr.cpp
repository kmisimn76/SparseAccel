  ...
  if (wrapc_switch_file_token.good())
  {
    ...
    string AESL_num;{
      ...
      if (!rtl_tv_out_file.is_open()) {
        rtl_tv_out_file.open(AUTOTB_TVOUT_PC_conv_out);
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<32> > conv_out_pc_buffer(1);
          int i = 0;
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            if (AESL_token != "") {
              conv_out_pc_buffer[i] = AESL_token.c_str();;
              i++;
            }
          ...
          if (i > 0) {
            ((int*)__xlx_apatb_param_conv_out)[0] = conv_out_pc_buffer[0].to_int64();
          }
        } // end transaction
      } // end file is good
...
// print bias_in Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_bias_in);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_bias_in, __xlx_sprintf_buffer.data()); 
  }
...
// print weight_in Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_weight_in);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_weight_in, __xlx_sprintf_buffer.data()); 
  }
...
// print data_in Transactions
{
  ...
  {
    sc_bv<8> __xlx_tmp_lv = *((char*)__xlx_apatb_param_data_in);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_data_in, __xlx_sprintf_buffer.data()); 
  }
...
// print conv_out Transactions
{
  ...
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_conv_out);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVIN_conv_out, __xlx_sprintf_buffer.data()); 
  }
...
{
  sprintf(__xlx_sprintf_buffer.data(), "[[transaction]] %d\n", AESL_transaction);
  aesl_fh.write(AUTOTB_TVOUT_conv_out, __xlx_sprintf_buffer.data());
  {
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_conv_out);
    sprintf(__xlx_sprintf_buffer.data(), "%s\n", __xlx_tmp_lv.to_string(SC_HEX).c_str());
    aesl_fh.write(AUTOTB_TVOUT_conv_out, __xlx_sprintf_buffer.data()); 
