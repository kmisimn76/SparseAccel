...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { co_1_out2_din { O 9 vector } co_1_out2_full_n { I 1 bit } co_1_out2_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ro_out3 \
    op interface \
    ports { ro_out3_din { O 9 vector } ro_out3_full_n { I 1 bit } ro_out3_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_so_out4 \
    op interface \
    ports { so_out4_din { O 9 vector } so_out4_full_n { I 1 bit } so_out4_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ho_out \
    op interface \
    ports { ho_out_din { O 9 vector } ho_out_full_n { I 1 bit } ho_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ho_out9 \
    op interface \
    ports { ho_out9_din { O 9 vector } ho_out9_full_n { I 1 bit } ho_out9_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_wo_out \
    op interface \
    ports { wo_out_din { O 9 vector } wo_out_full_n { I 1 bit } wo_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { wo_out10_din { O 9 vector } wo_out10_full_n { I 1 bit } wo_out10_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p_out11 \
    op interface \
    ports { p_out11_din { O 9 vector } p_out11_full_n { I 1 bit } p_out11_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p_out14 \
    op interface \
    ports { p_out14_din { O 9 vector } p_out14_full_n { I 1 bit } p_out14_write { O 1 bit } } \
} "
}
