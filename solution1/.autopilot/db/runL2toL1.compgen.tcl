...
set id 76
set name Conv_sysarr_mul_10s_10s_10_1_1
...
set id 78
set name Conv_sysarr_ama_addmuladd_10ns_10ns_10s_10ns_10_4_1
...
set out_width 10
set exp (i0+i1)*i2+i3
set arg_lists {i0 {10 0 +} i1 {10 0 +} s {10 1 +} i2 {10 1 +} m {10 1 +} i3 {10 0 +} p {10 1 +} c_expval {c} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_l2_0 \
    op interface \
    ports { data_l2_0_address0 { O 10 vector } data_l2_0_ce0 { O 1 bit } data_l2_0_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_l2_1 \
    op interface \
    ports { data_l2_1_address0 { O 10 vector } data_l2_1_ce0 { O 1 bit } data_l2_1_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_l2_2 \
    op interface \
    ports { data_l2_2_address0 { O 10 vector } data_l2_2_ce0 { O 1 bit } data_l2_2_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename data_l2_3 \
    op interface \
    ports { data_l2_3_address0 { O 10 vector } data_l2_3_ce0 { O 1 bit } data_l2_3_q0 { I 8 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { empty_15_dout { I 32 vector } empty_15_empty_n { I 1 bit } empty_15_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_r \
    op interface \
    ports { r_dout { I 10 vector } r_empty_n { I 1 bit } r_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_s \
    op interface \
    ports { s_dout { I 10 vector } s_empty_n { I 1 bit } s_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_empty \
    op interface \
    ports { empty_dout { I 10 vector } empty_empty_n { I 1 bit } empty_read { O 1 bit } } \
} "
}
