...
set ID 190
set hasByteEnable 0
set MemName Conv_sysarr_dataflow_in_loop_LOOP_S_OUTER_data_l1_0_memcore
...
set MemName Conv_sysarr_dataflow_in_loop_LOOP_S_OUTER_data_l1_0
...
set ID 191
set hasByteEnable 0
set MemName Conv_sysarr_dataflow_in_loop_LOOP_S_OUTER_output_l1_0_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 196
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName Conv_sysarr_dataflow_in_loop_LOOP_S_OUTER_output_l1_0
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition:
set ID 192
set FifoName Conv_sysarr_fifo_w20_d2_S
set InstName p_c_U
...
# FIFO definition:
set ID 195
set FifoName Conv_sysarr_fifo_w18_d2_S
...
# FIFO definition:
set ID 206
set FifoName Conv_sysarr_fifo_w20_d4_S
set InstName ho_c9_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 213
set FifoName Conv_sysarr_fifo_w20_d3_S
set InstName ko_2_c15_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_so \
    op interface \
    ports { so { I 32 vector } so_ap_vld { I 1 bit } } \
} "
}
