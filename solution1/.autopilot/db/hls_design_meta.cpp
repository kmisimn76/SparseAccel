...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("data_in_V_dout", 64, hls_in, 2, "ap_fifo", "fifo_data", 1),
	Port_Property("data_in_V_empty_n", 1, hls_in, 2, "ap_fifo", "fifo_status", 1),
	Port_Property("data_in_V_read", 1, hls_out, 2, "ap_fifo", "fifo_update", 1),
