...
extern "C" void Conv_sysarr_dbbuf(__cosim_s8__*, __cosim_s8__*, __cosim_s8__*, __cosim_s8__*);
extern "C" void apatb_Conv_sysarr_dbbuf_hw(volatile void * __xlx_apatb_param_bias_in, volatile void * __xlx_apatb_param_weight_in, volatile void * __xlx_apatb_param_data_in, volatile void * __xlx_apatb_param_conv_out) {
  ...
  vector<__cosim_s8__> __xlx_bias_in_tmp_vec;
  while (!((hls::stream<__cosim_s8__>*)__xlx_apatb_param_bias_in)->empty() && __xlx_bias_in_V_tmp_Count < __xlx_bias_in_V_read_Size) {
    __xlx_bias_in_tmp_vec.push_back(((hls::stream<__cosim_s8__>*)__xlx_apatb_param_bias_in)->read());
    __xlx_bias_in_V_tmp_Count++;
  }
  ap_apatb_bias_in_V_cap_bc = __xlx_bias_in_tmp_vec.size();
  // store input buffer
  __cosim_s8__* __xlx_bias_in_input_buffer= new __cosim_s8__[__xlx_bias_in_tmp_vec.size()];
  ...
  vector<__cosim_s8__> __xlx_weight_in_tmp_vec;
  while (!((hls::stream<__cosim_s8__>*)__xlx_apatb_param_weight_in)->empty() && __xlx_weight_in_V_tmp_Count < __xlx_weight_in_V_read_Size) {
    __xlx_weight_in_tmp_vec.push_back(((hls::stream<__cosim_s8__>*)__xlx_apatb_param_weight_in)->read());
    __xlx_weight_in_V_tmp_Count++;
  }
  ap_apatb_weight_in_V_cap_bc = __xlx_weight_in_tmp_vec.size();
  // store input buffer
  __cosim_s8__* __xlx_weight_in_input_buffer= new __cosim_s8__[__xlx_weight_in_tmp_vec.size()];
  ...
  __cosim_s8__* __xlx_conv_out_input_buffer= new __cosim_s8__[ap_apatb_conv_out_V_cap_bc];
  // DUT call
  ...
  for (unsigned i = 0; i <ap_apatb_conv_out_V_cap_bc; ++i)
    ((hls::stream<__cosim_s8__>*)__xlx_apatb_param_conv_out)->write(__xlx_conv_out_input_buffer[i]);
}
