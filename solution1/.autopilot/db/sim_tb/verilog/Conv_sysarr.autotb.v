...
`define AUTOTB_DUT      Conv_sysarr
`define AUTOTB_DUT_INST AESL_inst_Conv_sysarr
`define AUTOTB_TOP      apatb_Conv_sysarr_top
`define AUTOTB_LAT_RESULT_FILE "Conv_sysarr.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "Conv_sysarr.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_Conv_sysarr_top
...
`define AUTOTB_TVIN_param_in_V  "./c.Conv_sysarr.autotvin_param_in_V.dat"
`define AUTOTB_TVIN_bias_in_V  "./c.Conv_sysarr.autotvin_bias_in_V.dat"
`define AUTOTB_TVIN_weight_in_V  "./c.Conv_sysarr.autotvin_weight_in_V.dat"
`define AUTOTB_TVIN_data_in_V  "./c.Conv_sysarr.autotvin_data_in_V.dat"
`define AUTOTB_TVIN_conv_out_V  "./c.Conv_sysarr.autotvin_conv_out_V.dat"
`define AUTOTB_TVIN_param_in_V_out_wrapc  "./rtl.Conv_sysarr.autotvin_param_in_V.dat"
`define AUTOTB_TVIN_bias_in_V_out_wrapc  "./rtl.Conv_sysarr.autotvin_bias_in_V.dat"
`define AUTOTB_TVIN_weight_in_V_out_wrapc  "./rtl.Conv_sysarr.autotvin_weight_in_V.dat"
`define AUTOTB_TVIN_data_in_V_out_wrapc  "./rtl.Conv_sysarr.autotvin_data_in_V.dat"
`define AUTOTB_TVIN_conv_out_V_out_wrapc  "./rtl.Conv_sysarr.autotvin_conv_out_V.dat"
`define AUTOTB_TVOUT_conv_out_V  "./c.Conv_sysarr.autotvout_conv_out_V.dat"
`define AUTOTB_TVOUT_conv_out_V_out_wrapc  "./impl_rtl.Conv_sysarr.autotvout_conv_out_V.dat"
module `AUTOTB_TOP;
...
wire  bias_in_V_read;
wire [255 : 0] weight_in_V_dout;
wire  weight_in_V_empty_n;
wire  weight_in_V_read;
wire [255 : 0] data_in_V_dout;
wire  data_in_V_empty_n;
wire  data_in_V_read;
wire [255 : 0] conv_out_V_din;
...
wire [255 : 0] fifoweight_in_V_dout;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.Conv_sysarr.autotvout_conv_out_V.dat", "r");
    fp2 = $fopen("./impl_rtl.Conv_sysarr.autotvout_conv_out_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.Conv_sysarr.autotvout_conv_out_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.Conv_sysarr.autotvout_conv_out_V.dat\"!");
    else begin
        $display("Comparing rtl.Conv_sysarr.autotvout_conv_out_V.dat with impl_rtl.Conv_sysarr.autotvout_conv_out_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
initial begin : proc_gen_data_in_V_internal_ready
    ...
    `define STREAM_SIZE_IN_param_in_V "./stream_size_in_param_in_V.dat"
