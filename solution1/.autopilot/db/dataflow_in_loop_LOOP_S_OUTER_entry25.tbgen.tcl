set moduleName dataflow_in_loop_LOOP_S_OUTER_entry25
set isTopModule 0
...
set C_modelName {dataflow_in_loop_LOOP_S_OUTER.entry25}
...
set C_modelArgList {
	...
	{ co_1_out2 int 9 regular {fifo 1}  }
	{ ro_out int 32 regular {fifo 1}  }
	{ ro_out3 int 9 regular {fifo 1}  }
	{ so_out int 32 regular {fifo 1}  }
	{ so_out4 int 9 regular {fifo 1}  }
	{ p_out5 int 32 regular {fifo 1}  }
	{ p_out6 int 32 regular {fifo 1}  }
	{ p_out7 int 32 regular {fifo 1}  }
	{ p_out8 int 32 regular {fifo 1}  }
	{ ho_out int 9 regular {fifo 1}  }
	{ ho_out9 int 9 regular {fifo 1}  }
	{ wo_out int 9 regular {fifo 1}  }
	{ wo_out10 int 9 regular {fifo 1}  }
	{ p_out11 int 9 regular {fifo 1}  }
	{ p_out12 int 32 regular {fifo 1}  }
	{ p_out13 int 32 regular {fifo 1}  }
	{ p_out14 int 9 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "p_read", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "co_1_out2", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "ro_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "ro_out3", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "so_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "so_out4", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "ho_out", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "ho_out9", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "wo_out", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "wo_out10", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_out11", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_out12", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_out13", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_out14", "interface" : "fifo", "bitwidth" : 9, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ ro_out3_din sc_out sc_lv 9 signal 20 } 
	...
	{ so_out4_din sc_out sc_lv 9 signal 22 } 
	...
	{ p_out14_din sc_out sc_lv 9 signal 34 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "co_1_out2_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "co_1_out2", "role": "din" }} , 
 	...
 	{ "name": "ro_out3_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "ro_out3", "role": "din" }} , 
 	...
 	{ "name": "so_out4_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "so_out4", "role": "din" }} , 
 	...
 	{ "name": "ho_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "ho_out", "role": "din" }} , 
 	...
 	{ "name": "ho_out9_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "ho_out9", "role": "din" }} , 
 	...
 	{ "name": "wo_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "wo_out", "role": "din" }} , 
 	...
 	{ "name": "wo_out10_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "wo_out10", "role": "din" }} , 
 	...
 	{ "name": "p_out11_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "p_out11", "role": "din" }} , 
 	...
 	{ "name": "p_out14_din", "direction": "out", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "p_out14", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	co_1 { ap_none {  { co_1 in_data 0 9 } } }
	ro { ap_none {  { ro in_data 0 32 } } }
	so { ap_none {  { so in_data 0 32 } } }
	p_read2 { ap_none {  { p_read2 in_data 0 32 } } }
	p_read3 { ap_none {  { p_read3 in_data 0 32 } } }
	ho { ap_none {  { ho in_data 0 9 } } }
	wo { ap_none {  { wo in_data 0 9 } } }
	...
	co_1_out2 { ap_fifo {  { co_1_out2_din fifo_data 1 9 }  { co_1_out2_full_n fifo_status 0 1 }  { co_1_out2_write fifo_update 1 1 } } }
	ro_out { ap_fifo {  { ro_out_din fifo_data 1 32 }  { ro_out_full_n fifo_status 0 1 }  { ro_out_write fifo_update 1 1 } } }
	ro_out3 { ap_fifo {  { ro_out3_din fifo_data 1 9 }  { ro_out3_full_n fifo_status 0 1 }  { ro_out3_write fifo_update 1 1 } } }
	so_out { ap_fifo {  { so_out_din fifo_data 1 32 }  { so_out_full_n fifo_status 0 1 }  { so_out_write fifo_update 1 1 } } }
	so_out4 { ap_fifo {  { so_out4_din fifo_data 1 9 }  { so_out4_full_n fifo_status 0 1 }  { so_out4_write fifo_update 1 1 } } }
	...
	ho_out { ap_fifo {  { ho_out_din fifo_data 1 9 }  { ho_out_full_n fifo_status 0 1 }  { ho_out_write fifo_update 1 1 } } }
	ho_out9 { ap_fifo {  { ho_out9_din fifo_data 1 9 }  { ho_out9_full_n fifo_status 0 1 }  { ho_out9_write fifo_update 1 1 } } }
	wo_out { ap_fifo {  { wo_out_din fifo_data 1 9 }  { wo_out_full_n fifo_status 0 1 }  { wo_out_write fifo_update 1 1 } } }
	wo_out10 { ap_fifo {  { wo_out10_din fifo_data 1 9 }  { wo_out10_full_n fifo_status 0 1 }  { wo_out10_write fifo_update 1 1 } } }
	p_out11 { ap_fifo {  { p_out11_din fifo_data 1 9 }  { p_out11_full_n fifo_status 0 1 }  { p_out11_write fifo_update 1 1 } } }
	...
	p_out14 { ap_fifo {  { p_out14_din fifo_data 1 9 }  { p_out14_full_n fifo_status 0 1 }  { p_out14_write fifo_update 1 1 } } }
}
