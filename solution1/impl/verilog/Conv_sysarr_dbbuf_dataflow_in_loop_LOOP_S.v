...
module Conv_sysarr_dbbuf_dataflow_in_loop_LOOP_S (
        ap_clk,
        ap_rst,
        p_read,
        p_read1,
...
wire    dataflow_in_loop_LOOP_S_entry17_U0_ap_start;
wire    dataflow_in_loop_LOOP_S_entry17_U0_ap_done;
wire    dataflow_in_loop_LOOP_S_entry17_U0_ap_continue;
wire    dataflow_in_loop_LOOP_S_entry17_U0_ap_idle;
wire    dataflow_in_loop_LOOP_S_entry17_U0_ap_ready;
wire   [10:0] dataflow_in_loop_LOOP_S_entry17_U0_p_c_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_p_c_write;
wire   [10:0] dataflow_in_loop_LOOP_S_entry17_U0_p_c1_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_p_c1_write;
wire   [8:0] dataflow_in_loop_LOOP_S_entry17_U0_ko_1_c_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_ko_1_c_write;
wire   [8:0] dataflow_in_loop_LOOP_S_entry17_U0_co_2_c_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_co_2_c_write;
wire   [9:0] dataflow_in_loop_LOOP_S_entry17_U0_co_2_c2_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_co_2_c2_write;
wire   [10:0] dataflow_in_loop_LOOP_S_entry17_U0_r_c_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_r_c_write;
wire   [9:0] dataflow_in_loop_LOOP_S_entry17_U0_r_c3_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_r_c3_write;
wire   [10:0] dataflow_in_loop_LOOP_S_entry17_U0_s_c_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_s_c_write;
wire   [9:0] dataflow_in_loop_LOOP_S_entry17_U0_s_c4_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_s_c4_write;
wire   [31:0] dataflow_in_loop_LOOP_S_entry17_U0_p_c5_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_p_c5_write;
wire   [31:0] dataflow_in_loop_LOOP_S_entry17_U0_p_c6_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_p_c6_write;
wire   [9:0] dataflow_in_loop_LOOP_S_entry17_U0_p_c7_din;
wire    dataflow_in_loop_LOOP_S_entry17_U0_p_c7_write;
...
wire    runL2toL1_U0_empty_14_read;
wire    runL2toL1_U0_co_2_read;
...
wire   [8:0] runSysArr_U0_data_l1buf_0_address0;
wire    runSysArr_U0_data_l1buf_0_ce0;
wire   [8:0] runSysArr_U0_data_l1buf_1_address0;
wire    runSysArr_U0_data_l1buf_1_ce0;
wire   [8:0] runSysArr_U0_data_l1buf_2_address0;
wire    runSysArr_U0_data_l1buf_2_ce0;
wire   [8:0] runSysArr_U0_data_l1buf_3_address0;
wire    runSysArr_U0_data_l1buf_3_ce0;
wire    runSysArr_U0_empty_read;
wire    runSysArr_U0_ko_1_read;
wire   [8:0] runSysArr_U0_output_l1_3_address0;
wire    runSysArr_U0_output_l1_3_ce0;
wire    runSysArr_U0_output_l1_3_we0;
wire   [31:0] runSysArr_U0_output_l1_3_d0;
wire   [8:0] runSysArr_U0_output_l1_3_address1;
wire    runSysArr_U0_output_l1_3_ce1;
wire   [8:0] runSysArr_U0_output_l1_2_address0;
wire    runSysArr_U0_output_l1_2_ce0;
wire    runSysArr_U0_output_l1_2_we0;
wire   [31:0] runSysArr_U0_output_l1_2_d0;
wire   [8:0] runSysArr_U0_output_l1_2_address1;
wire    runSysArr_U0_output_l1_2_ce1;
wire   [8:0] runSysArr_U0_output_l1_1_address0;
wire    runSysArr_U0_output_l1_1_ce0;
wire    runSysArr_U0_output_l1_1_we0;
wire   [31:0] runSysArr_U0_output_l1_1_d0;
wire   [8:0] runSysArr_U0_output_l1_1_address1;
wire    runSysArr_U0_output_l1_1_ce1;
wire   [8:0] runSysArr_U0_output_l1_0_address0;
wire    runSysArr_U0_output_l1_0_ce0;
wire    runSysArr_U0_output_l1_0_we0;
wire   [31:0] runSysArr_U0_output_l1_0_d0;
wire   [8:0] runSysArr_U0_output_l1_0_address1;
wire    runSysArr_U0_output_l1_0_ce1;
...
wire    p_c1_empty_n;
wire    ko_1_c_full_n;
wire   [8:0] ko_1_c_dout;
wire    ko_1_c_empty_n;
wire    co_2_c_full_n;
wire   [8:0] co_2_c_dout;
wire    co_2_c_empty_n;
wire    co_2_c2_full_n;
wire   [9:0] co_2_c2_dout;
wire    co_2_c2_empty_n;
wire    r_c_full_n;
wire   [10:0] r_c_dout;
wire    r_c_empty_n;
wire    r_c3_full_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready;
wire    ap_sync_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready;
reg   [1:0] dataflow_in_loop_LOOP_S_entry17_U0_ap_ready_count;
...
reg    ap_sync_reg_runSysArr_U0_ap_ready;
wire    ap_sync_runSysArr_U0_ap_ready;
reg   [1:0] runSysArr_U0_ap_ready_count;
wire    dataflow_in_loop_LOOP_S_entry17_U0_start_full_n;
wire    dataflow_in_loop_LOOP_S_entry17_U0_start_write;
...
#0 ap_sync_reg_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready = 1'b0;
#0 dataflow_in_loop_LOOP_S_entry17_U0_ap_ready_count = 2'd0;
...
#0 ap_sync_reg_runSysArr_U0_ap_ready = 1'b0;
#0 runSysArr_U0_ap_ready_count = 2'd0;
end

Conv_sysarr_dbbuf_dataflow_in_loop_LOOP_S_data_l1buf_0 #(
    .DataWidth( 8 ),
    .AddressRange( 512 ),
    .AddressWidth( 9 ))
data_l1buf_0_U(
...
Conv_sysarr_dbbuf_dataflow_in_loop_LOOP_S_entry17 dataflow_in_loop_LOOP_S_entry17_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Conv_sysarr_dbbuf_runWeight2Reg runWeight2Reg_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Conv_sysarr_dbbuf_runL2toL1 runL2toL1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Conv_sysarr_dbbuf_runSysArr runSysArr_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
Conv_sysarr_dbbuf_fifo_w11_d2_S p_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w11_d2_S p_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w9_d2_S ko_1_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w9_d2_S co_2_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w10_d2_S co_2_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w11_d2_S r_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w10_d2_S r_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w11_d2_S s_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w10_d2_S s_c4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w32_d2_S p_c5_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w10_d2_S p_c7_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w9_d2_S ko_1_c8_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_0_0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_0_1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_0_2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_0_3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_1_0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_1_1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_1_2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_1_3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_2_0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_2_1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_2_2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_2_3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_3_0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_3_1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_3_2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
Conv_sysarr_dbbuf_fifo_w8_d2_S weight_regfile_3_3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_runSysArr_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_runSysArr_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (dataflow_in_loop_LOOP_S_entry17_U0_ap_ready == 1'b0))) begin
        dataflow_in_loop_LOOP_S_entry17_U0_ap_ready_count <= (dataflow_in_loop_LOOP_S_entry17_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (dataflow_in_loop_LOOP_S_entry17_U0_ap_ready == 1'b1))) begin
        dataflow_in_loop_LOOP_S_entry17_U0_ap_ready_count <= (dataflow_in_loop_LOOP_S_entry17_U0_ap_ready_count + 2'd1);
    end
end
...
always @ (posedge ap_clk) begin
    if (((ap_sync_ready == 1'b1) & (runSysArr_U0_ap_ready == 1'b0))) begin
        runSysArr_U0_ap_ready_count <= (runSysArr_U0_ap_ready_count - 2'd1);
    end else if (((ap_sync_ready == 1'b0) & (runSysArr_U0_ap_ready == 1'b1))) begin
        runSysArr_U0_ap_ready_count <= (runSysArr_U0_ap_ready_count + 2'd1);
    end
end
...
assign ap_sync_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready = (dataflow_in_loop_LOOP_S_entry17_U0_ap_ready | ap_sync_reg_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready);

assign ap_sync_done = runSysArr_U0_ap_done;

assign ap_sync_ready = (ap_sync_runWeight2Reg_U0_ap_ready & ap_sync_runSysArr_U0_ap_ready & ap_sync_runL2toL1_U0_ap_ready & ap_sync_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready);

assign ap_sync_runL2toL1_U0_ap_ready = (runL2toL1_U0_ap_ready | ap_sync_reg_runL2toL1_U0_ap_ready);

assign ap_sync_runSysArr_U0_ap_ready = (runSysArr_U0_ap_ready | ap_sync_reg_runSysArr_U0_ap_ready);
...
assign dataflow_in_loop_LOOP_S_entry17_U0_ap_continue = 1'b1;

assign dataflow_in_loop_LOOP_S_entry17_U0_ap_start = ((ap_sync_reg_dataflow_in_loop_LOOP_S_entry17_U0_ap_ready ^ 1'b1) & ap_start);

assign dataflow_in_loop_LOOP_S_entry17_U0_start_full_n = 1'b1;

assign dataflow_in_loop_LOOP_S_entry17_U0_start_write = 1'b0;

assign output_l1_0_address0 = runSysArr_U0_output_l1_0_address0;

assign output_l1_0_address1 = runSysArr_U0_output_l1_0_address1;

assign output_l1_0_ce0 = runSysArr_U0_output_l1_0_ce0;

assign output_l1_0_ce1 = runSysArr_U0_output_l1_0_ce1;

assign output_l1_0_d0 = runSysArr_U0_output_l1_0_d0;

assign output_l1_0_d1 = 32'd0;

assign output_l1_0_we0 = runSysArr_U0_output_l1_0_we0;

assign output_l1_0_we1 = 1'b0;

assign output_l1_1_address0 = runSysArr_U0_output_l1_1_address0;

assign output_l1_1_address1 = runSysArr_U0_output_l1_1_address1;

assign output_l1_1_ce0 = runSysArr_U0_output_l1_1_ce0;

assign output_l1_1_ce1 = runSysArr_U0_output_l1_1_ce1;

assign output_l1_1_d0 = runSysArr_U0_output_l1_1_d0;

assign output_l1_1_d1 = 32'd0;

assign output_l1_1_we0 = runSysArr_U0_output_l1_1_we0;

assign output_l1_1_we1 = 1'b0;

assign output_l1_2_address0 = runSysArr_U0_output_l1_2_address0;

assign output_l1_2_address1 = runSysArr_U0_output_l1_2_address1;

assign output_l1_2_ce0 = runSysArr_U0_output_l1_2_ce0;

assign output_l1_2_ce1 = runSysArr_U0_output_l1_2_ce1;

assign output_l1_2_d0 = runSysArr_U0_output_l1_2_d0;

assign output_l1_2_d1 = 32'd0;

assign output_l1_2_we0 = runSysArr_U0_output_l1_2_we0;

assign output_l1_2_we1 = 1'b0;

assign output_l1_3_address0 = runSysArr_U0_output_l1_3_address0;

assign output_l1_3_address1 = runSysArr_U0_output_l1_3_address1;

assign output_l1_3_ce0 = runSysArr_U0_output_l1_3_ce0;

assign output_l1_3_ce1 = runSysArr_U0_output_l1_3_ce1;

assign output_l1_3_d0 = runSysArr_U0_output_l1_3_d0;

assign output_l1_3_d1 = 32'd0;

assign output_l1_3_we0 = runSysArr_U0_output_l1_3_we0;
...
endmodule //Conv_sysarr_dbbuf_dataflow_in_loop_LOOP_S
