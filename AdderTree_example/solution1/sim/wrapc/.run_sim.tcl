...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "adder_tree_large.autotvin.dat"
	set constFileTvOut       "adder_tree_large.autotvout.dat"
	set constFileHdlTvIn     "adder_tree_large.autohdltvin.dat"
	set constFileHdlTvOut    "adder_tree_large.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
