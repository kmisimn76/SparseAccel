...
if {[file isfile adder_tree_large.autotvin.dat]} {
	file delete -force adder_tree_large.autotvin.dat
}

if {[file isfile adder_tree_large.autotvout.dat]} {
	file delete -force adder_tree_large.autotvout.dat
}
