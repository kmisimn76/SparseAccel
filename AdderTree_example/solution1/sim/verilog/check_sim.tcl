...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.adder_tree_large.autotvin_a.dat"
         "c.adder_tree_large.autotvin_b.dat"
         "c.adder_tree_large.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.adder_tree_large.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
