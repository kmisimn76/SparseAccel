...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.adder_tree_large.autotvin_b.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.adder_tree_large.autotvout_b.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 7;
parameter DEPTH = 32'd 100;
parameter DLY = 0.1;
