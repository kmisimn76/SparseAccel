...
#ifndef XILINX
// Vectorized data type for steaming interfaces
typedef ap_axiu<LANE_NUM*DP_WIDTH,0,0,0> k2k_data_xlane;
typedef ap_axiu<VEC_SIZE*LANE_NUM*DP_WIDTH,0,0,0> k2k_data_vecxlane;
